        ...
        <div className="mx-auto max-w-md rounded-lg p-6">
            ...
            <form onSubmit={createTodo} className="mb-6 flex gap-2">
                <input
                    ...
                    className={`todo-input-field flex-1 rounded-md border border-gray-300 px-4 py-2 text-black focus:ring-2 focus:ring-blue-500 focus:outline-none`}
                />
                <button
                    className="create-todo-button rounded-md bg-blue-600 px-4 py-2 font-medium text-white hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:outline-none"
                    type="submit"
                >
                    Add
                </button>
